...
/**
 * This Field Adds Missing Functionality that Needs to be Present in the Joomla's Text Field, such as Data Attributes.
 * We Use Duck Punching to Avoid Overriding/Duplicating the Original Functions.
 */
class ArkFormFieldExtendedText extends JFormFieldText
{
	/**
	 * The form field type.
	 *
