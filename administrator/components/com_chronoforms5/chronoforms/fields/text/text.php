...
class Text {
	...
	static $configs = array(
		'name' => array('value' => 'text_XNX_', 'label' => 'Field Name', 'type' => 'text', 'class' => 'element_field_name L', 'sublabel' => 'No spaces or special characters.'),
		'id' => array('value' => 'text_XNX_', 'label' => 'Field ID', 'type' => 'text', 'class' => 'L'),
